...
<body>
  ...
  <div id='mainpan'>
    ...
    <div id='userpan'>
      ...
      <div id='droite'>
	      <?PHP print_keyword_search(); print_xiti_code($keywords_url); ?>
	      <img src="/images-pub/paris-sans-agences-160x400.gif" title='20 Euros pour 6 mois sur TOP-IMMOBILIER-PARTICULIERS.FR' alt='20 Euros pour 6 mois sur TOP-IMMOBILIER-PARTICULIERS.FR' />
	    </div>
  <div id='centre'>
