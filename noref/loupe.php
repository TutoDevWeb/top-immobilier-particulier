...
<body>
  ...
  <div id='mainpan'>
    ...
    <div id='userpan'>
      ...
      <div id='loupe'>
        <h1>Vous pouvez régler la taille d'affichage des textes contenus dans les pages de ce site.</h1>
			  <div id='explain'>
          <p class='text12'>Les textes ont une taille de police relative, c'est à dire agrandissable selon les besoins.</p>
          <p class='text12'>Pour cela vous devez régler votre navigateur.</p>
        ...
        <ul>
          ...
          <li class='text12'><strong>Pour Mozilla, Firefox ou Netscape</strong> : Maintenir la touche Ctrl enfoncé tout en tapant sur la touche + pour agrandir et - pour diminuer.</li>
          <li class='text12'><strong>Pour Opera</strong> : appuyez sur les touches + ou - du pavé numérique. Ou bien allez dans Affichage >> Zoom et choisir.</li>
