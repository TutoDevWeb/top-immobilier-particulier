...
// V�rification des arguments dans le cas de l'action 'print_form'
			...
			<tr>
				<td>
					<p><strong>Votre Message</strong><br />
						<textarea id='message' name="message" cols="45" rows="5" class="text12j"></textarea>
					</p>
					<p><strong>Votre Mail</strong><br />
						...
						<input id='mail_from' name='mail_from' type='text' class='text12j' size='50' maxlength='128' />
					</p>
					<table id='code'>
						<tr>
							<td>
