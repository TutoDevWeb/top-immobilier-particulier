...
// La tache sera lanc�e toutes les heures entres 12 heures et 22 heures soit 10 fois par jours.
// Nombre de click � chaque lancement de la tache.
// Dans ce cas on aura 60 click simuler par jours.
$nb_click = 10;

dtb_connection(__FILE__, __LINE__);

tracking(CODE_DBG, 'OK', "Cron Click $nb_click", __FILE__, __LINE__);
