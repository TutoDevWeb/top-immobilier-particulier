...
if ( compte_annonce_existe($_SESSION['tel_ins'],__FILE__,__LINE__) === true ) { 
  ...
  } else tracking_session_annonce(CODE_CTA,'OK',"Demande de mise à jour de l'annonce $tel_ins par ida::$ida qui n'est pas son propriétaire",__FILE__,__LINE__);
} else tracking_session_annonce(CODE_CTA,'OK',"Demande de mise à jour d'une annonce qui n'existe plus",__FILE__,__LINE__);
?>