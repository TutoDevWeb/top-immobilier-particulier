...
<body onload="load_map();" onunload="GUnload(); clear_window();">
	...
	<div id='mainpan'>
		<div id='userpan'>
			...
			<?PHP
			$ida_array = select_annnonce($first = 0, $last = 3);
...
function print_select_dom() {
	...
	$result = dtb_query($query, __FILE__, __LINE__, DEBUG_INDEX);
...
function get_nb_ano_by_typp_ville_dept($zone_ville, $num_dept, $nb_appartement, $nb_maison, $nb_loft, $nb_chalet) {
	...
	$result = dtb_query($select, __FILE__, __LINE__, 0);
