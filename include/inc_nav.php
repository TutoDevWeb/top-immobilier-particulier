...
//------------------------------------------------------------------------
function print_if_no_data($connexion) {
?>
	<table id='annonce'>
		<tr>
			<td class='cell_b'></td>
			<td class='cell_c'>
				...
				echo "<p>&nbsp;</p>";
				echo "<p>&nbsp;</p>";
				tracking_session_annonce($connexion, CODE_CTA, 'OK', "Pas de données en Session", __FILE__, __LINE__);
				echo "<p>&nbsp;</p>";
				?>
			</td>
			<td class='cell_b'></td>
...
function print_info_attente_paiement($tel_ins) {
	...
	echo "<tr><td>Durèe de parution</td><td>$duree_annonce mois à compter de la réception du chèque</td></tr>";
