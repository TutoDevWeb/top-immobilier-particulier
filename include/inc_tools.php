...
function print_tools($type='') {
  ...
  if ( $type == 'blank' ) {
    ?>
		<div id='toolscenter'>
    <ul id='tools'>
	    <li><a href='http://www.top-immobilier-particuliers.fr/' target='_blank' title="Aller à l'accueil">www.top-immobilier-particuliers.fr</a>&nbsp;|&nbsp;</li> 
	    ...
	    <li><a href='http://www.top-immobilier-particuliers.fr/noref/faq.php' target='_blank' title='Réponses aux questions fréquemment posées'>FAQ</a>&nbsp;|&nbsp;</li>
    ...
    ?>
		<div id='toolscenter'>
    <ul id='tools'>
	    <li><a href='http://www.top-immobilier-particuliers.fr/' title="Aller à l'accueil">www.top-immobilier-particuliers.fr</a>&nbsp;|&nbsp;</li> 
	    <li><a href='http://www.top-immobilier-particuliers.fr/plan-du-site.htm' title='Voir le Plan du site'>Plan du site</a>&nbsp;|&nbsp;</li>
	    <li><a href='http://www.top-immobilier-particuliers.fr/noref/faq.php' title='Réponses aux questions fréquemment posées'>FAQ</a>&nbsp;|&nbsp;</li>
