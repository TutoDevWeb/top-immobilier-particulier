...
define('SITE_NAME','TOP-IMMOBILIER-PARTICULIERS');
define('SITE_NAME_FR','TOP-IMMOBILIER-PARTICULIERS.FR');
define('URL_SITE','http://www.top-immobilier-particuliers.fr/');
define('URL_SHORT_SITE','www.top-immobilier-particuliers.fr');
define('URL_ADMIN','http://www.top-immobilier-particuliers.fr/admin/');

define('URL_SITE_LEXIQUE','http://lexique.top-immobilier-particuliers.fr/');
define('URL_SHORT_SITE_LEXIQUE','lexique.top-immobilier-particuliers.fr');

// Email du webmaster
define('EMAIL_WEBMASTER','equipe@top-immobilier-particuliers.fr');
...
// Code de refus sur des echec à des tentatives de connexion
...
//-----------------------------------------------------------------------------
// Nombre de jour après lesquels on relance une annonce en attente de paiement
define ('DUREE_RELANCER_ATTENTE_PAIEMENT',15);
// Nombre de jour après lesquels on efface une annonce en attente de paiement
