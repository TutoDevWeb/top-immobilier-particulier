function Localization () {
  ...
  this.show = function () {
    ...
    var lien_ville   = ( zone_ville  != '' ) ? " &raquo; <a href='#' title=\"Voir les résultats sur : "+zone_ville+"\" onClick='switchzone.ville(\""+escape(zone_dept)+"\",\""+escape(zone_ville)+"\");return false;'>"+zone_ville+"</a>"    : '';
    var lien_dept    = ( zone_dept   != '' ) ? " &raquo; <a href='#' title=\"Voir les résultats sur : "+zone_dept+"\" onClick='switchzone.dept(\""+escape(zone_dept)+"\");return false;'>"+zone_dept+"</a>"       : '' ;
    var lien_region  = ( zone_region != '' ) ? " &raquo; <a href='#' title=\"Voir les résultats sur : "+zone_region+"\" onClick='switchzone.region(\""+escape(zone_region)+"\");return false;'>"+zone_region+"</a>" : '';
    var lien_pays    = ( zone_pays   != '' ) ? " :: <a href='#' title=\"Voir les résultats sur : "+zone_pays+"\" onClick='switchzone.pays(\""+escape(zone_pays)+"\");return false;'>"+zone_pays+"</a>"            : '';       
